...
class Avril_FSD::ConcurrentQue_Server_Control* ptr_LaunchConcurrency_Control = NULL;
...
void Avril_FSD::ConcurrentQue_Server::Initialise_Control()
{
    Create_Control_Of_LaunchConcurrency();
}

void Avril_FSD::ConcurrentQue_Server::Thread_Start(class Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char concurrent_CoreId)
{
...
void Avril_FSD::ConcurrentQue_Server::Thread_End(class Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char concurrent_CoreId)
{
...
void Avril_FSD::ConcurrentQue_Server::Create_ConcurrentQue_Server_Global()
{
    Set_LaunchConcurrency_Global(new class Avril_FSD::ConcurrentQue_Server_Global());
    while (Get_LaunchConcurrency_Global() == NULL) {}
}
void Avril_FSD::ConcurrentQue_Server::Create_Control_Of_LaunchConcurrency()
{
    Set_Control_Of_LaunchConcurrency(new class Avril_FSD::ConcurrentQue_Server_Control(Get_LaunchConcurrency_Global(), Get_LaunchConcurrency_Global()->Get_number_Implemented_Cores()));
    while (Get_Control_Of_LaunchConcurrency() == NULL) { /* wait untill created */ }
}
Avril_FSD::ConcurrentQue_Server_Global* Avril_FSD::ConcurrentQue_Server::Get_LaunchConcurrency_Global()
{
    return ptr_Global;
}
Avril_FSD::ConcurrentQue_Server_Control* Avril_FSD::ConcurrentQue_Server::Get_Control_Of_LaunchConcurrency()
{
    return ptr_LaunchConcurrency_Control;
}
void Avril_FSD::ConcurrentQue_Server::Set_LaunchConcurrency_Global(ConcurrentQue_Server_Global* global)
{
    ptr_Global = global;
}
void Avril_FSD::ConcurrentQue_Server::Set_Control_Of_LaunchConcurrency(ConcurrentQue_Server_Control* control)
{
