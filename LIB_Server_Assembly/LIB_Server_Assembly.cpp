...
Avril_FSD::CLIBServerConcurrencyLibrary::CLIBServerConcurrencyLibrary()
{

}
// This is an example of an exported function.
void * Avril_FSD::CLIBServerConcurrencyLibrary::Initialise_Server_Assembly()
{
...
bool Avril_FSD::CLIBServerConcurrencyLibrary::Get_Flag_IsStackLoaded_Server_InputAction(class Avril_FSD::Framework_Server* obj)
{
...
bool Avril_FSD::CLIBServerConcurrencyLibrary::Get_Flag_IsStackLoaded_Server_OutputRecieve(class Avril_FSD::Framework_Server* obj)
{
...
bool Avril_FSD::CLIBServerConcurrencyLibrary::Get_Flag_IsInitialised_Avril_FSD_ServerAssembly(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::CLIBServerConcurrencyLibrary::Pop_Stack_Output(class Avril_FSD::Framework_Server* obj)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_Data_Control()->Pop_Stack_Output(obj);
}
void Avril_FSD::CLIBServerConcurrencyLibrary::Push_Stack_InputPraises(class Avril_FSD::Framework_Server* obj)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_Data_Control()->Push_Stack_InputPraises(obj);
}

__int8 Avril_FSD::CLIBServerConcurrencyLibrary::Get_PraiseEventId(class Avril_FSD::Framework_Server* obj)
{
    _PraiseEventId = obj->Get_Server_Assembly()->Get_Data()->GetBuffer_OutputBackDouble()->Get_out_praiseEventId();
    return _PraiseEventId;
}
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_PraiseEventId(class Avril_FSD::Framework_Server* obj, __int8 value)
{
    obj->Get_Server_Assembly()->Get_Data()->GetBuffer_InputBackDouble()->Set_in_praiseEventId(value);
}
//
bool Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise0_Input_IsPingActive(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise0_Input_IsPingActive(class Avril_FSD::Framework_Server* obj, bool value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_I()->Get_Praise0_Input()->Set_ping_Active(value);
}
bool Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise0_Output_IsPingActive(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise0_Output_IsPingActive(class Avril_FSD::Framework_Server* obj, bool value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise0_Output()->Set_ping_Active(value);
}
//
float Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise1_Input_mouseDelta_X(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise1_Input_mouseDelta_X(class Avril_FSD::Framework_Server* obj, float value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_I()->Get_Praise1_Input()->Set_mouse_X(value);
}
float Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise1_Input_mouseDelta_Y(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise1_Input_mouseDelta_Y(class Avril_FSD::Framework_Server* obj, float value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_I()->Get_Praise1_Input()->Set_mouse_Y(value);
}

Eigen::Vector3d Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise1_Output_Player_Fowards(class Avril_FSD::Framework_Server* obj)
{
...
Eigen::Vector3d Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise1_Output_Player_Up(class Avril_FSD::Framework_Server* obj)
{
    Avril_FSD::Praise1_Output* outputSebset = (Avril_FSD::Praise1_Output*)obj->Get_Server_Assembly()->Get_Data()->GetBuffer_OutputFrontDouble()->Get_praiseOutputBuffer_Subset();
    _praise1_Output_Player_Camera_Up = outputSebset->GetUp();
    return _praise1_Output_Player_Camera_Up;
}
Eigen::Vector3d Avril_FSD::CLIBServerConcurrencyLibrary::Get_Praise1_Output_Player_Right(class Avril_FSD::Framework_Server* obj)
{
    Avril_FSD::Praise1_Output* outputSebset = (Avril_FSD::Praise1_Output*)obj->Get_Server_Assembly()->Get_Data()->GetBuffer_OutputFrontDouble()->Get_praiseOutputBuffer_Subset();
    _praise1_Output_Player_Camera_Right = outputSebset->GetRight();
    return _praise1_Output_Player_Camera_Right;
}
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise1_Output_Player_Fowards(class Avril_FSD::Framework_Server* obj, Eigen::Vector3d value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise1_Output()->SetFowards(value);
}
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise1_Output_Player_Up(class Avril_FSD::Framework_Server* obj, Eigen::Vector3d value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise1_Output()->SetUp(value);
}
void Avril_FSD::CLIBServerConcurrencyLibrary::Set_Praise1_Output_Player_Right(class Avril_FSD::Framework_Server* obj, Eigen::Vector3d value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise1_Output()->SetUp(value);
}
