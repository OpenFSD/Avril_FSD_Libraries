...
class Avril_FSD::Framework_Server* obj = NULL;
...
void * Avril_FSD::LIB_ServerLibrary::Initialise_Server_Assembly()
{
    obj = new class Avril_FSD::Framework_Server();
    while (obj == NULL) {}
    return (void*)obj;
}
bool Avril_FSD::LIB_ServerLibrary::Get_Flag_isNewInputDataReady(class Avril_FSD::Framework_Server* obj)
{
...
bool Avril_FSD::LIB_ServerLibrary::Get_flag_isNewOutputDataReady(class Avril_FSD::Framework_Server* obj)
{
...
bool Avril_FSD::LIB_ServerLibrary::Get_Flag_IsStackLoaded_Server_InputAction(class Avril_FSD::Framework_Server* obj)
{
...
bool Avril_FSD::LIB_ServerLibrary::Get_Flag_IsStackLoaded_Server_OutputRecieve(class Avril_FSD::Framework_Server* obj)
{
...
bool Avril_FSD::LIB_ServerLibrary::Get_Flag_IsInitialised_Avril_FSD_ServerAssembly(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::LIB_ServerLibrary::Pop_Stack_Output(class Avril_FSD::Framework_Server* obj)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_Data_Control()->Pop_Stack_Output();
}
void Avril_FSD::LIB_ServerLibrary::Push_Stack_InputPraises(class Avril_FSD::Framework_Server* obj)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_Data_Control()->Push_Stack_InputPraises();
}

__int8 Avril_FSD::LIB_ServerLibrary::Get_PraiseEventId(class Avril_FSD::Framework_Server* obj)
{
    _PraiseEventId = obj->Get_Server_Assembly()->Get_Data()->GetBuffer_OutputBackDouble()->GetPraiseEventId();
    return _PraiseEventId;
}
void Avril_FSD::LIB_ServerLibrary::Set_PraiseEventId(class Avril_FSD::Framework_Server* obj, __int8 value)
{
    obj->Get_Server_Assembly()->Get_Data()->GetBuffer_InputBackDouble()->Set_in_praiseEventId(value);
}
//
bool Avril_FSD::LIB_ServerLibrary::Get_Praise0_Input_IsPingActive(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::LIB_ServerLibrary::Set_Praise0_Input_IsPingActive(class Avril_FSD::Framework_Server* obj, bool value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_I()->Get_Praise0_Input()->Set_ping_Active(value);
}
bool Avril_FSD::LIB_ServerLibrary::Get_Praise0_Output_IsPingActive(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::LIB_ServerLibrary::Set_Praise0_Output_IsPingActive(class Avril_FSD::Framework_Server* obj, bool value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise0_Output()->Set_ping_Active(value);
}
//
float Avril_FSD::LIB_ServerLibrary::Get_Praise1_Input_mouseDelta_X(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::LIB_ServerLibrary::Set_Praise1_Input_mouseDelta_X(class Avril_FSD::Framework_Server* obj, float value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_I()->Get_Praise1_Input()->Set_mouse_delta_X(value);
}
float Avril_FSD::LIB_ServerLibrary::Get_Praise1_Input_mouseDelta_Y(class Avril_FSD::Framework_Server* obj)
{
...
void Avril_FSD::LIB_ServerLibrary::Set_Praise1_Input_mouseDelta_Y(class Avril_FSD::Framework_Server* obj, float value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_I()->Get_Praise1_Input()->Set_mouse_delta_Y(value);
}

std::array<float, 3> Avril_FSD::LIB_ServerLibrary::Get_Praise1_Output_Player_Fowards(class Avril_FSD::Framework_Server* obj)
{
...
std::array<float, 3> Avril_FSD::LIB_ServerLibrary::Get_Praise1_Output_Player_Up(class Avril_FSD::Framework_Server* obj)
{
    _Praise1_Output_Player_Up = std::array<float, 3> {_up.at(0), _up.at(1), _up.at(2)};
    return _Praise1_Output_Player_Up;
}
std::array<float, 3> Avril_FSD::LIB_ServerLibrary::Get_Praise1_Output_Player_Right(class Avril_FSD::Framework_Server* obj)
{
    _Praise1_Output_Player_Right = std::array<float, 3> {_right.at(0), _right.at(1), _right.at(2)};
    return _Praise1_Output_Player_Right;
}
void Avril_FSD::LIB_ServerLibrary::Set_Praise1_Output_Player_Fowards(class Avril_FSD::Framework_Server* obj, std::array<float, 3> value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise1_Output()->SetFowards(value);
}
void Avril_FSD::LIB_ServerLibrary::Set_Praise1_Output_Player_Up(class Avril_FSD::Framework_Server* obj, std::array<float, 3> value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise1_Output()->SetUp(value);
}
void Avril_FSD::LIB_ServerLibrary::Set_Praise1_Output_Player_Right(class Avril_FSD::Framework_Server* obj, std::array<float, 3> value)
{
    obj->Get_Server_Assembly()->Get_Data()->Get_User_O()->Get_Praise1_Output()->SetUp(value);
}
