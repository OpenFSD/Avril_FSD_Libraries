...
namespace Avril_FSD
{
    ...
    public:
        ...
        class ConcurrentQue_Server_Framework* Get_Program_ConcurrentQue_Server();
        class WriteEnable_ServerInputAction_Framework* Get_Program_WriteEnable_ServerInputAction();
        class WriteEnable_ServerOutputRecieve_Framework* Get_Program_WriteEnable_ServerOutputRecieve();
