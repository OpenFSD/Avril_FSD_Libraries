...
namespace Avril_FSD
{
    class WriteEnable_ServerInputAction_Control
    {
    public:
        WriteEnable_ServerInputAction_Control(class Avril_FSD::WriteEnable_ServerInputAction_Global* global);
        ~WriteEnable_ServerInputAction_Control();
        void WriteEnable_Activate(class WriteEnable_ServerInputAction_Framework* obj, unsigned char coreId);
        void WriteEnable_SortQue(class WriteEnable_ServerInputAction_Framework* obj);
        void WriteEnable_Request(class WriteEnable_ServerInputAction_Framework* obj, unsigned char coreId);
        void WriteQue_Update(class WriteEnable_ServerInputAction_Framework* obj);
    ...
    private:
        void DynamicStagger(class WriteEnable_ServerInputAction_Framework* obj, unsigned char coreId);
        void WriteEnable_ShiftQueValues(class WriteEnable_ServerInputAction_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B);
