...
namespace Avril_FSD
{
    ...
    public:
        ...
        class ConcurrentQue_Server_Global* Get_LaunchConcurrency_Global();
        class ConcurrentQue_Server_LaunchConcurrency_Control* Get_Control_Of_LaunchConcurrency();

    private:
        void Create_ConcurrentQue_Server_Global();
        void Create_Control_Of_LaunchConcurrency();

        void Set_LaunchConcurrency_Global(ConcurrentQue_Server_Global* global);
        void Set_Control_Of_LaunchConcurrency(class ConcurrentQue_Server_LaunchConcurrency_Control* control);
    };
}