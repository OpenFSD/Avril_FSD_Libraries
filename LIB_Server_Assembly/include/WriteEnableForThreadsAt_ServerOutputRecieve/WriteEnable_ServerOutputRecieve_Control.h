...
namespace Avril_FSD
{
    class WriteEnable_ServerOutputRecieve_Control
    {
    public:
        WriteEnable_ServerOutputRecieve_Control(class Avril_FSD::WriteEnable_ServerOutputRecieve_Global* global);
        ~WriteEnable_ServerOutputRecieve_Control();
        void WriteEnable_Activate(class WriteEnable_ServerOutputRecieve_Framework* obj, unsigned char coreId);
        void WriteEnable_SortQue(class WriteEnable_ServerOutputRecieve_Framework* obj);
        void WriteEnable_Request(class WriteEnable_ServerOutputRecieve_Framework* obj, unsigned char coreId);
        void WriteQue_Update(class WriteEnable_ServerOutputRecieve_Framework* obj);
    ...
    private:
        void DynamicStagger(class WriteEnable_ServerOutputRecieve_Framework* obj, unsigned char coreId);
        void WriteEnable_ShiftQueValues(class WriteEnable_ServerOutputRecieve_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B);
