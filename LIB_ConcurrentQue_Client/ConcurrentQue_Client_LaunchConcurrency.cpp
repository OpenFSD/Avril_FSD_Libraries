...
{
    Set_Control_Of_LaunchConcurrency(new class Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control(Get_class_LaunchConcurrency_Global(), Get_class_LaunchConcurrency_Global()->Get_number_Implemented_Cores()));
    while (Get_class_Control_Of_LaunchConcurrency() == NULL) { /* wait untill created */ }
}
Avril_FSD::ConcurrentQue_Client_Global* Avril_FSD::ConcurrentQue_Client_LaunchConcurrency::Get_class_LaunchConcurrency_Global()
{
    return ptr_Global;
}
Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control* Avril_FSD::ConcurrentQue_Client_LaunchConcurrency::Get_class_Control_Of_LaunchConcurrency()
{
