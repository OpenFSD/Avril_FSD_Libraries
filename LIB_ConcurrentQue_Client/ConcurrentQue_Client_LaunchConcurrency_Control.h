...
namespace Avril_FSD
{
    ...
    {
    public:
        ConcurrentQue_Client_LaunchConcurrency_Control(class ConcurrentQue_Client_Global* ptr_Global, unsigned char number_Implemented_Cores);
        virtual ~ConcurrentQue_Client_LaunchConcurrency_Control();

        void LaunchEnable_Activate(class ConcurrentQue_Client_Global* ptr_Global);
        void LaunchEnable_Request(unsigned char concurrent_CoreId, class ConcurrentQue_Client_Global* ptr_Global);
        void LaunchEnable_SortQue(class ConcurrentQue_Client_Global* ptr_Global, unsigned char number_Implemented_Cores);
