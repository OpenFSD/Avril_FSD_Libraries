...
Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::ConcurrentQue_Client_LaunchConcurrency_Control(Avril_FSD::ConcurrentQue_Client_Global* global, unsigned char number_Implemented_Cores)
{
...
void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_Activate(class Avril_FSD::ConcurrentQue_Client_Global* global)
{
    Set_state_ConcurrentCore(Get_flag_CoreId_Of_CoreToLaunch(), global->Get_flag_core_ACTIVE());
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_Request(unsigned char concurrent_CoreId, class Avril_FSD::ConcurrentQue_Client_Global* global)
{
...
void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_SortQue(class Avril_FSD::ConcurrentQue_Client_Global* ptr_Global, unsigned char number_Implemented_Cores)
{
...
void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::LaunchQue_Update(unsigned char number_Implemented_Cores)
{
...
void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::DynamicStagger(unsigned char ptr_coreId)
{
...
void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::LaunchEnable_ShiftQueValues(unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B)
{
...
unsigned char Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Get_concurrentCycle_Try_CoreId_Index()
{
...
bool Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Get_flag_praisingLaunch()
{
...
unsigned char Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Get_new_concurrentCycle_Try_CoreId_Index()
{
    return _new_concurrentCycle_Try_CoreId_Index;
}

unsigned char Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Get_flag_CoreId_Of_CoreToLaunch()
{
...
void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_concurrentCycle_Try_CoreId_Index(unsigned char concurrentCycle_Try_CoreId_Index)
{
    _concurrentCycle_Try_CoreId_Index = concurrentCycle_Try_CoreId_Index;
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_count_LaunchActive_For(int count_LaunchActive_For, unsigned char concurrent_CoreId)
{
    _count_LaunchActive_For[concurrent_CoreId] = count_LaunchActive_For;
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_count_LaunchIdle_For(int count_LaunchIdle_For, unsigned char concurrent_CoreId)
{
    _que_CoreToLaunch[concurrent_CoreId] = count_LaunchIdle_For;
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_flag_praisingLaunch(bool flag_praisingLaunch)
{
    _flag_praisingLaunch = flag_praisingLaunch;
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_stack_PriseEventId(std::vector<unsigned char>* stack_PriseEventId)
{
    _stack_PriseEventId = stack_PriseEventId;
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_state_ConcurrentCore(bool state_ConcurrentCore, unsigned char concurrent_CoreId)
{
    _state_ConcurrentCore[concurrent_CoreId] = state_ConcurrentCore;
}

void Avril_FSD::ConcurrentQue_Client_LaunchConcurrency_Control::Set_new_concurrentCycle_Try_CoreId_Index(unsigned char new_concurrentCycle_Try_CoreId_Index)
{
