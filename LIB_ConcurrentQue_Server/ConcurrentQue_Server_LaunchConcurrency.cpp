...
#include <cstddef>
    ...
    class Avril_FSD::ConcurrentQue_Server_Global* ptr_Global = NULL;
    class Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control* ptr_LaunchConcurrency_Control = NULL;

    Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::ConcurrentQue_Server_LaunchConcurrency()
    {
        Create_ConcurrentQue_Server_Global();
    }
    ...
    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Thread_Start(unsigned char concurrent_CoreId)
    {
    ...
    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Initialise_Control()
    {
        Create_Control_Of_LaunchConcurrency();
    }

    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Thread_End(unsigned char concurrent_CoreId)
    {
    ...
    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Create_ConcurrentQue_Server_Global()
    {
        Set_LaunchConcurrency_Global(new class Avril_FSD::ConcurrentQue_Server_Global());
        while (Get_LaunchConcurrency_Global() == NULL) {}
    }
    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Create_Control_Of_LaunchConcurrency()
    {
        Set_Control_Of_LaunchConcurrency(new class Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control(Get_LaunchConcurrency_Global(), Get_LaunchConcurrency_Global()->Get_NumCores()));
        while (Get_Control_Of_LaunchConcurrency() == NULL) { /* wait untill created */ }
    }
    Avril_FSD::ConcurrentQue_Server_Global* Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Get_LaunchConcurrency_Global()
    {
        return ptr_Global;
    }
    Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control* Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Get_Control_Of_LaunchConcurrency()
    {
        return ptr_LaunchConcurrency_Control;
    }
    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Set_LaunchConcurrency_Global(ConcurrentQue_Server_Global* global)
    {
        ptr_Global = global;
    }
    void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency::Set_Control_Of_LaunchConcurrency(ConcurrentQue_Server_LaunchConcurrency_Control* control)
    {
