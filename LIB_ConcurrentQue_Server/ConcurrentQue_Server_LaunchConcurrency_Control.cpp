...
Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::ConcurrentQue_Server_LaunchConcurrency_Control(
    Avril_FSD::ConcurrentQue_Server_Global* ptr_Global,
...
void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::LaunchEnable_Activate(
    class Avril_FSD::ConcurrentQue_Server_Global* ptr_Global
)
{
    SetFlag_ConcurrentCoreState(GetFlag_CoreId_Of_CoreToLaunch(), ptr_Global->GetConst_Core_ACTIVE());
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::LaunchEnable_Request(
...
void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::LaunchEnable_SortQue(
    class Avril_FSD::ConcurrentQue_Server_Global* ptr_Global,
    unsigned char number_Implemented_Cores
)
{
...
void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::LaunchQue_Update(
    unsigned char number_Implemented_Cores
)
{
...
unsigned char Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_concurrent_CoreId_Index()
{
    return concurrent_CoreId_Index;
}

unsigned char Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_coreId_To_Launch()
{
    return que_CoreToLaunch[0];
}

bool Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_State_ConcurrentCore(unsigned char concurrent_CoreId)
{
    return state_ConcurrentCore[concurrent_CoreId];
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::SetFlag_PraisingLaunch(bool value)
{
    flag_praisingLaunch = value;
}

unsigned char Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_new_concurrent_CoreId_Index()
{
    return new_concurrent_CoreId_Index;
}

std::vector<unsigned char>* Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_Stack_PriseEventId()
{
    return stack_PriseEventId;
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Set_concurrent_CoreId_Index(unsigned char value)
{
    concurrent_CoreId_Index = value;
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::SetFlag_ConcurrentCoreState(unsigned char concurrent_CoreId, bool value)
{
    state_ConcurrentCore[concurrent_CoreId] = value;
}


bool Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::GetFlag_PraisingLaunch()
{
    return flag_praisingLaunch;
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Set_new_concurrent_CoreId_Index(unsigned char value)
{
    new_concurrent_CoreId_Index = value;
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::DynamicStagger(
...
void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::LaunchEnable_ShiftQueValues(
...
int Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_count_LaunchActive_For(unsigned char concurrent_CoreId)
{
    return count_LaunchActive_For[concurrent_CoreId];
}

int Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_count_LaunchIdle_For(unsigned char concurrent_CoreId)
{
    return count_LaunchIdle_For[concurrent_CoreId];
}

unsigned char Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::GetFlag_CoreId_Of_CoreToLaunch()
{
    return que_CoreToLaunch[0];
}

unsigned char Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Get_que_CoreToLaunch(unsigned char index)
{
    return que_CoreToLaunch[index];
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Set_count_LaunchActive_For(unsigned char concurrent_CoreId, int value)
{
    count_LaunchActive_For[concurrent_CoreId] = value;
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Set_count_LaunchIdle_For(unsigned char concurrent_CoreId, int value)
{
    count_LaunchIdle_For[concurrent_CoreId] = value;
}

void Avril_FSD::ConcurrentQue_Server_LaunchConcurrency_Control::Set_que_CoreToLaunch(unsigned char concurrent_CoreId, unsigned char value)
{
