...
Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::WriteEnableStack_ServerOutputRecieve_Control(Avril_FSD::WriteEnableStack_ServerOutputRecieve_Global* global)
{
...
Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::~WriteEnableStack_ServerOutputRecieve_Control()
{

}

void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::WriteEnable_Activate(unsigned char coreId, Avril_FSD::WriteEnableStack_ServerOutputRecieve_Global* global)
{
    for (unsigned char index = 0; index < global->Get_NumCores(); index++)
    {
...
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::WriteEnable_SortQue(Avril_FSD::WriteEnableStack_ServerOutputRecieve_Global* global)
{
...
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::WriteEnable_Request(unsigned char coreId, Avril_FSD::WriteEnableStack_ServerOutputRecieve_Global* global)
{
...
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::WriteQue_Update(Avril_FSD::WriteEnableStack_ServerOutputRecieve_Global* global)
{
    for (unsigned char index = 0; index < global->Get_NumCores(); index++)
    {
...
unsigned char Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Get_coreIdForWritePraiseIndex()
{
    return coreId_For_WritePraise_Index;
}
int Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Get_count_WriteActive(unsigned char coreId)
{
    return ptr_count_CoreId_WriteActive[coreId];
}
int Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Get_count_WriteIdle(unsigned char coreId)
{
    return ptr_count_CoreId_WriteIdle[coreId];
}
int Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Get_count_WriteWait(unsigned char coreId)
{
    return ptr_count_CoreId_WriteWait[coreId];
}
unsigned char Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::GetFlag_CoreId_WriteEnable()
{
    return ptr_que_CoreToWrite[0];
}
unsigned char Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Get_new_coreIdForWritePraiseIndex()
{
    return ptr_new_coreId_For_WritePraise_Index;
}
unsigned char Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Get_que_CoreToWrite(unsigned char index)
{
    return ptr_que_CoreToWrite[index];
}

void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Set_count_WriteActive(unsigned char coreId, int value)
{
    ptr_count_CoreId_WriteActive[coreId] = value;
}
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Set_count_WriteIdle(unsigned char coreId, int value)
{
    ptr_count_CoreId_WriteIdle[coreId] = value;
}
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Set_count_WriteWait(unsigned char coreId, int value)
{
    ptr_count_CoreId_WriteWait[coreId] = value;
}
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::SetFlag_readWrite_Open(bool value)
{
    praisingWrite = value;
}
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::SetFlag_writeState(unsigned char coreId, unsigned char index, bool value)
{
    flag_WriteState[coreId][index] = value;
}
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Set_new_coreIdForWritePraiseIndex(unsigned char value)
{
    ptr_new_coreId_For_WritePraise_Index = value;
}
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Set_que_CoreToWrite(unsigned char index, unsigned char value)
{
    ptr_que_CoreToWrite[index] = value;
}

void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::DynamicStagger(
...
void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::WriteEnable_ShiftQueValues(
...
bool Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::GetFlag_readWrite_Open()
{
    return praisingWrite;
}

bool Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::GetFlag_writeState(unsigned char coreId, unsigned char index)
{
    return flag_WriteState[coreId][index];
}

void Avril_FSD::WriteEnableStack_ServerOutputRecieve_Control::Set_coreIdForWritePraiseIndex(unsigned char value)
{
