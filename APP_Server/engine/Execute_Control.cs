...
namespace Avril_FSD_ServerAssembly
{
    ...
    {
        bool flag_SystemInitialised;
        bool[] flag_ThreadInitialised;
        ...
        public bool GetFlag_Server_Shell_Initialised()
        {
            ...
            for (byte index = 0; index < Avril_FSD_ServerAssembly.Framework.GetGameServer().GetGlobal().Get_NumCores(); index++)
            {
