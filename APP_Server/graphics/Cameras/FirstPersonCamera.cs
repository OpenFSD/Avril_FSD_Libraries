...
namespace Avril_FSD_ServerAssembly
{
    public class FirstPersonCamera : ICamera
    {
        ...
        {
            Set_Pitch(Get_Pitch() + (float)((System.Math.PI / 180) * deltaDegY));
            if(Get_Pitch() > (float)(System.Math.PI / 180) * 85)
            {
                Set_Pitch((float)(System.Math.PI / 180) * 85);
            }
            if (Get_Pitch() <= (System.Math.PI / 180) * -85)
            {
                Set_Pitch((float)(System.Math.PI / 180) * -85);
            }
        }
        ...
        {
            Set_Yaw(Get_Yaw() + (float)((System.Math.PI / 180) * deltaDegX));
            if (Get_Yaw() > (float)(System.Math.PI / 180) * 180)
            {
                Set_Yaw(Get_Yaw() - (float)(System.Math.PI * 2));
            }
            if (Get_Yaw() <= (System.Math.PI / 180) * -180)
            {
                Set_Yaw(Get_Yaw() + (float)(System.Math.PI * 2));
            }
        }
        public void UpdateVectors()
        {
            ...
            fowards.X = (float)(System.Math.Cos(_pitch) * System.Math.Cos(_yaw));
            fowards.Y = (float)(System.Math.Sin(_pitch));
            fowards.Z = (float)(System.Math.Cos(_pitch) * System.Math.Sin(_yaw));
