...
namespace Avril_FSD
{
    ...
    WriteEnable_Stack_Server_InputAction_Global::WriteEnable_Stack_Server_InputAction_Global()
    {
    ...
    unsigned char WriteEnable_Stack_Server_InputAction_Global::Get_NumCores()
    {
        return ptr_num_Implemented_Cores;
    }
    bool WriteEnable_Stack_Server_InputAction_Global::GetConst_Write_IDLE(unsigned char index)
    {
        return flag_write_IDLE[index];
    }
    bool WriteEnable_Stack_Server_InputAction_Global::GetConst_Write_WAIT(unsigned char index)
    {
        return flag_write_WAIT[index];
    }
    bool WriteEnable_Stack_Server_InputAction_Global::GetConst_Write_WRITE(unsigned char index)
    {
