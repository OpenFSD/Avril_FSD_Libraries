...
void Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Request_Wait_Launch(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char concurrent_CoreId)
{
    obj->Get_LaunchEnableForConcurrentThread()->Thread_Start(obj, concurrent_CoreId);
}

void Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Thread_End(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char concurrent_CoreId)
{
    obj->Get_LaunchEnableForConcurrentThread()->Thread_End(obj, concurrent_CoreId);
}

__int8 Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Get_coreId_To_Launch(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj)
{
    return obj->Get_LaunchEnableForConcurrentThread()->Get_Control_Of_LaunchConcurrency()->Get_que_CoreToLaunch(0);
}

bool Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Get_Flag_Active(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj)
{
    return obj->Get_LaunchEnableForConcurrentThread()->Get_LaunchConcurrency_Global()->Get_flag_core_ACTIVE();
}

bool Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Get_Flag_ConcurrentCoreState(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char concurrent_CoreId)
{
...
bool Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Get_Flag_Idle(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj)
{
    return obj->Get_LaunchEnableForConcurrentThread()->Get_LaunchConcurrency_Global()->Get_flag_core_IDLE();
}

bool Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Get_State_LaunchBit(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj)
{
    return obj->Get_LaunchEnableForConcurrentThread()->Get_Control_Of_LaunchConcurrency()->Get_state_ConcurrentCore(0);
}

void Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Set_state_ConcurrentCore(Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* obj, unsigned char concurrent_CoreId, bool value)
{
...
Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Get_LaunchEnableForConcurrentThreadsAt_END_Framework()
{
    return ptr_LaunchEnableForConcurrentThreadsAt_END_Framework;
}

void Avril_FSD::CLIBLaunchEnableForConcurrentThreadsAtCLIENT::Set_LaunchEnableForConcurrentThreadsAt_END_Framework(class Avril_FSD::LaunchEnableForConcurrentThreadsAt_END_Framework* framework)
{
