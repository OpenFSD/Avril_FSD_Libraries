...
Avril_FSD::ConcurrentQue_CLIENT_Control::ConcurrentQue_CLIENT_Control(Avril_FSD::ConcurrentQue_CLIENT_Global* global, unsigned char number_Implemented_Cores)
{
...
Avril_FSD::ConcurrentQue_CLIENT_Control::~ConcurrentQue_CLIENT_Control()
{

}

void Avril_FSD::ConcurrentQue_CLIENT_Control::LaunchEnable_Activate(Avril_FSD::ConcurrentQue_CLIENT_Framework* obj)
{
...
void Avril_FSD::ConcurrentQue_CLIENT_Control::LaunchEnable_Request(Avril_FSD::ConcurrentQue_CLIENT_Framework* obj, unsigned char concurrent_CoreId)
{
...
void Avril_FSD::ConcurrentQue_CLIENT_Control::LaunchEnable_SortQue(Avril_FSD::ConcurrentQue_CLIENT_Framework* obj, unsigned char number_Implemented_Cores)
{
...
void Avril_FSD::ConcurrentQue_CLIENT_Control::LaunchQue_Update(Avril_FSD::ConcurrentQue_CLIENT_Framework* obj, unsigned char number_Implemented_Cores)
{
...
void Avril_FSD::ConcurrentQue_CLIENT_Control::DynamicStagger(Avril_FSD::ConcurrentQue_CLIENT_Framework* obj, unsigned char concurrent_CoreId)
{
    if (obj->Get_ConcurrentQue()->Get_Control_Of_LaunchConcurrency()->Get_concurrentCycle_Try_CoreId_Index() == concurrent_CoreId)
    {
        //exit early
...
void Avril_FSD::ConcurrentQue_CLIENT_Control::LaunchEnable_ShiftQueValues(Avril_FSD::ConcurrentQue_CLIENT_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B)
{
    int temp_Int;
...
unsigned char Avril_FSD::ConcurrentQue_CLIENT_Control::Get_concurrentCycle_Try_CoreId_Index()
{
    return _concurrentCycle_Try_CoreId_Index;
}

int Avril_FSD::ConcurrentQue_CLIENT_Control::Get_count_LaunchActive_For(unsigned char concurrent_CoreId)
{
    return _count_LaunchActive_For[concurrent_CoreId];
}

int Avril_FSD::ConcurrentQue_CLIENT_Control::Get_count_LaunchIdle_For(unsigned char concurrent_CoreId)
{
    return _count_LaunchIdle_For[concurrent_CoreId];
}

bool Avril_FSD::ConcurrentQue_CLIENT_Control::Get_flag_praisingLaunch()
{
    return _flag_praisingLaunch;
}

std::vector<unsigned char>* Avril_FSD::ConcurrentQue_CLIENT_Control::Get_stack_PriseEventId()
{
    return _stack_PriseEventId;
}

bool Avril_FSD::ConcurrentQue_CLIENT_Control::Get_state_ConcurrentCore(unsigned char concurrent_CoreId)
{
    return _state_ConcurrentCore[concurrent_CoreId];
}

unsigned char Avril_FSD::ConcurrentQue_CLIENT_Control::Get_new_concurrentCycle_Try_CoreId_Index()
{
    return _new_concurrentCycle_Try_CoreId_Index;
}

unsigned char Avril_FSD::ConcurrentQue_CLIENT_Control::Get_flag_CoreId_Of_CoreToLaunch()
{
    return _que_CoreToLaunch[0];
}

unsigned char Avril_FSD::ConcurrentQue_CLIENT_Control::Get_que_CoreToLaunch(unsigned char index)
{
    return _que_CoreToLaunch[index];
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_concurrentCycle_Try_CoreId_Index(unsigned char concurrentCycle_Try_CoreId_Index)
{
    _concurrentCycle_Try_CoreId_Index = concurrentCycle_Try_CoreId_Index;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_count_LaunchActive_For(int count_LaunchActive_For, unsigned char concurrent_CoreId)
{
    _count_LaunchActive_For[concurrent_CoreId] = count_LaunchActive_For;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_count_LaunchIdle_For(int count_LaunchIdle_For, unsigned char concurrent_CoreId)
{
    _que_CoreToLaunch[concurrent_CoreId] = count_LaunchIdle_For;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_flag_praisingLaunch(bool flag_praisingLaunch)
{
    _flag_praisingLaunch = flag_praisingLaunch;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_stack_PriseEventId(std::vector<unsigned char>* stack_PriseEventId)
{
    _stack_PriseEventId = stack_PriseEventId;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_state_ConcurrentCore(bool state_ConcurrentCore, unsigned char concurrent_CoreId)
{
    _state_ConcurrentCore[concurrent_CoreId] = state_ConcurrentCore;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_new_concurrentCycle_Try_CoreId_Index(unsigned char new_concurrentCycle_Try_CoreId_Index)
{
    _new_concurrentCycle_Try_CoreId_Index = new_concurrentCycle_Try_CoreId_Index;
}

void Avril_FSD::ConcurrentQue_CLIENT_Control::Set_que_CoreToLaunch(unsigned char concurrent_CoreId, unsigned char value)
{
