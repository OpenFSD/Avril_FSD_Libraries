...
namespace Avril_FSD
{
    ...
    WriteEnable_Stack_Client_OutputRecieve_Control::WriteEnable_Stack_Client_OutputRecieve_Control(
        class Avril_FSD::WriteEnable_Stack_Client_OutputRecieve_Global* global
    )
    {
    ...
    void WriteEnable_Stack_Client_OutputRecieve_Control::WriteQue_Update(class Avril_FSD::WriteEnable_Stack_Client_OutputRecieve_Global* global)
    {
        for (unsigned char index = 0; index < global->Get_NumCores(); index++)
        {
