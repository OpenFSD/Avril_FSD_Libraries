...
class Avril_FSD::Input_Control* ptr_input_Control = NULL;
__int8 in_praiseEventId = 255;
class Avril_FSD::Object* ptr_buffer_SubSet_InputPraise = NULL;
...
{
    ptr_buffer_SubSet_InputPraise = reinterpret_cast<class Object*>(praise0_value);
}

void Avril_FSD::Input::Set_Subset_InputBuffer(Avril_FSD::Praise1_Input* praise1_value)
{
    ptr_buffer_SubSet_InputPraise = reinterpret_cast<class Object*>(praise1_value);
}

void Avril_FSD::Input::Set_Subset_InputBuffer(Avril_FSD::Praise2_Input* praise2_value)
{
    ptr_buffer_SubSet_InputPraise = reinterpret_cast<class Object*>(praise2_value);
}