...
class Avril_FSD::Praise0_Input* ptr_Praise0_Input = NULL;
class Avril_FSD::Praise1_Input* ptr_Praise1_Input = NULL;
class Avril_FSD::Praise2_Input* ptr_Praise2_Input = NULL;
