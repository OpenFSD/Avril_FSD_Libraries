...
namespace Avril_FSD
{
    class ConcurrentQue_Server_Control
    {
    public:
        ConcurrentQue_Server_Control(class ConcurrentQue_Server_Global* global, unsigned char number_Implemented_Cores);
        virtual ~ConcurrentQue_Server_Control();

        void LaunchEnable_Activate(class Avril_FSD::ConcurrentQue_Server_Framework* obj);
        void LaunchEnable_Request(class Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char concurrent_CoreId);
        void LaunchEnable_SortQue(class Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char number_Implemented_Cores);
        void LaunchQue_Update(class Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char number_Implemented_Cores);
    ...
    private:
        void DynamicStagger(Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char coreId);
        void LaunchEnable_ShiftQueValues(Avril_FSD::ConcurrentQue_Server_Framework* obj, unsigned char concurrent_CoreId_A, unsigned char concurrent_CoreId_B);
