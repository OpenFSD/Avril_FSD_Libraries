...
#ifdef LIBCONCURRENTQUESEVER_EXPORTS
#define LIBCONCURRENTQUESERVER_API __declspec(dllexport)
#else
#define LIBCONCURRENTQUESERVER_API __declspec(dllimport)
#endif

namespace Avril_FSD
{
	// This class is exported from the dll
	class LIBCONCURRENTQUESERVER_API ConcurrentQue_Server {
	public:
		ConcurrentQue_Server();
		// TODO: add your methods here.
		static class ConcurrentQue_Server_Framework* Initialise_ConcurrentQue();
